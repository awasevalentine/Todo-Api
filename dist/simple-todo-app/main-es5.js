...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAuthenticationLogoutLogoutComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAuthenticationRegisterRegisterComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesImportantImportantComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesNewTodosNewTodosComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesPageLayoutPageLayoutComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesTodoUpdateTodoUpdateComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pages_page_layout_page_layout_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./pages/page-layout/page-layout.component */
    "./src/app/pages/page-layout/page-layout.component.ts");
    /* harmony import */


    var _pages_todos_todos_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./pages/todos/todos.component */
    "./src/app/pages/todos/todos.component.ts");
    /* harmony import */


    var _pages_new_todos_new_todos_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./pages/new-todos/new-todos.component */
    "./src/app/pages/new-todos/new-todos.component.ts");
    /* harmony import */


    var _pages_important_important_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./pages/important/important.component */
    "./src/app/pages/important/important.component.ts");
    /* harmony import */


    var _pages_todo_update_todo_update_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./pages/todo-update/todo-update.component */
    ...
    var _authentication_Guard_logged_in_guard__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./authentication/Guard/logged-in.guard */
    "./src/app/authentication/Guard/logged-in.guard.ts");

    var routes = [{
      path: '',
      component: _pages_page_layout_page_layout_component__WEBPACK_IMPORTED_MODULE_4__["PageLayoutComponent"]
    }, {
      path: 'dashboard',
      component: _pages_page_layout_page_layout_component__WEBPACK_IMPORTED_MODULE_4__["PageLayoutComponent"],
      children: [{
        ...
        path: 'task',
        component: _pages_todos_todos_component__WEBPACK_IMPORTED_MODULE_5__["TodosComponent"],
        canActivate: [_authentication_Guard_logged_in_guard__WEBPACK_IMPORTED_MODULE_10__["LoggedInGuard"]]
      }, {
        path: 'new-todos',
        component: _pages_new_todos_new_todos_component__WEBPACK_IMPORTED_MODULE_6__["NewTodosComponent"]
      }, {
        path: 'important',
        component: _pages_important_important_component__WEBPACK_IMPORTED_MODULE_7__["ImportantComponent"]
      }, {
        path: 'update',
        component: _pages_todo_update_todo_update_component__WEBPACK_IMPORTED_MODULE_8__["TodoUpdateComponent"]
      }, {
        path: 'login',
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _modules_appmaterial_appmaterial_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./modules/appmaterial/appmaterial.module */
    "./src/app/modules/appmaterial/appmaterial.module.ts");
    /* harmony import */


    var _pages_new_todos_new_todos_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./pages/new-todos/new-todos.component */
    "./src/app/pages/new-todos/new-todos.component.ts");
    /* harmony import */


    var _pages_page_layout_page_layout_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./pages/page-layout/page-layout.component */
    "./src/app/pages/page-layout/page-layout.component.ts");
    /* harmony import */
    ...
    var _pages_todos_todos_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./pages/todos/todos.component */
    "./src/app/pages/todos/todos.component.ts");
    /* harmony import */
    ...
    var _cores_services_todos_data_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./cores/services/todos-data.service */
    "./src/app/cores/services/todos-data.service.ts");
    /* harmony import */


    var _pages_important_important_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./pages/important/important.component */
    "./src/app/pages/important/important.component.ts");
    /* harmony import */


    var _pages_todo_update_todo_update_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./pages/todo-update/todo-update.component */
    "./src/app/pages/todo-update/todo-update.component.ts");
    /* harmony import */


    var _cores_myhover_directive__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./cores/myhover.directive */
    "./src/app/cores/myhover.directive.ts");
    /* harmony import */


    var _authentication_register_register_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./authentication/register/register.component */
    "./src/app/authentication/register/register.component.ts");
    /* harmony import */


    var _authentication_login_login_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./authentication/login/login.component */
    "./src/app/authentication/login/login.component.ts");
    /* harmony import */


    var _authentication_logout_logout_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./authentication/logout/logout.component */
    "./src/app/authentication/logout/logout.component.ts");
    /* harmony import */


    var _authentication_services_auth_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./authentication/services/auth.service */
    "./src/app/authentication/services/auth.service.ts");
    /* harmony import */


    var _authentication_Guard_logged_in_guard__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ./authentication/Guard/logged-in.guard */
    "./src/app/authentication/Guard/logged-in.guard.ts");
    /* harmony import */


    var angular_calendar__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! angular-calendar */
    "./node_modules/angular-calendar/fesm2015/angular-calendar.js");
    /* harmony import */


    var angular_calendar_date_adapters_date_fns__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _pages_new_todos_new_todos_component__WEBPACK_IMPORTED_MODULE_7__["NewTodosComponent"], _pages_page_layout_page_layout_component__WEBPACK_IMPORTED_MODULE_8__["PageLayoutComponent"], _pages_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_9__["DashboardComponent"], _pages_todos_todos_component__WEBPACK_IMPORTED_MODULE_10__["TodosComponent"], _pages_important_important_component__WEBPACK_IMPORTED_MODULE_14__["ImportantComponent"], _pages_todo_update_todo_update_component__WEBPACK_IMPORTED_MODULE_15__["TodoUpdateComponent"], _cores_myhover_directive__WEBPACK_IMPORTED_MODULE_16__["MyhoverDirective"], _authentication_register_register_component__WEBPACK_IMPORTED_MODULE_17__["RegisterComponent"], _authentication_login_login_component__WEBPACK_IMPORTED_MODULE_18__["LoginComponent"], _authentication_logout_logout_component__WEBPACK_IMPORTED_MODULE_19__["LogoutComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"], _modules_appmaterial_appmaterial_module__WEBPACK_IMPORTED_MODULE_6__["AppmaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_12__["HttpClientModule"], angular_calendar__WEBPACK_IMPORTED_MODULE_22__["CalendarModule"].forRoot({
  ...
  /***/
  function srcAppAuthenticationGuardLoggedInGuardTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAuthenticationLogoutLogoutComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAuthenticationLogoutLogoutComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    LogoutComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/authentication/logout/logout.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./logout.component.css */
      "./src/app/authentication/logout/logout.component.css"))["default"]]
    })], LogoutComponent);
    /***/
  },
  ...
  /***/
  function srcAppAuthenticationRegisterRegisterComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAuthenticationRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    RegisterComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/authentication/register/register.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./register.component.css */
      "./src/app/authentication/register/register.component.css"))["default"]]
    })], RegisterComponent);
    /***/
  },
  ...
  /***/
  function srcAppAuthenticationServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCoresMyhoverDirectiveTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MyhoverDirective", function () {
      return MyhoverDirective;
    });
    /* harmony import */
    ...
    var MyhoverDirective = /*#__PURE__*/function () {
      function MyhoverDirective(el, renderer) {
        _classCallCheck(this, MyhoverDirective);

        this.el = el;
        this.renderer = renderer;
      }

      _createClass(MyhoverDirective, [{
        key: "onMouseOver",
        value: function onMouseOver() {
          var part = this.el.nativeElement.querySelector('.examples');
    ...
    MyhoverDirective.ctorParameters = function () {
      return [{
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('mouseover')], MyhoverDirective.prototype, "onMouseOver", null);
    MyhoverDirective = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({
      selector: '[appMyhover]'
    })], MyhoverDirective);
    /***/
  },
  ...
  /***/
  function srcAppCoresServicesTodosDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TodosDataService", function () {
    ...
    var TodosDataService = /*#__PURE__*/function () {
      function TodosDataService(http) {
        _classCallCheck(this, TodosDataService);

        this.http = http;
        this.apiUrl = 'http://localhost:3300/todo/api'; //private headers = new HttpHeaders().set('Content-Type', 'application/json');
      ...
      _createClass(TodosDataService, [{
        key: "getTodo",
        value: function getTodo() {
          return this.http.get("".concat(this.apiUrl, "/getTodos")
          /*,{ headers: this.headers}*/
          );
        }
      }, {
        key: "getImportantTodos",
        value: function getImportantTodos() {
          var _this = this;

          return new Promise(function (resolve, reject) {
            _this.getTodo().subscribe(function (todos) {
              // console.log(`retured todos on get important function`, todos);
              var importantTodos = todos.filter(function (td) {
                return td.important;
              });
        ...
        value: function getTodoById(id) {
          return this.http.get("".concat(this.apiUrl, "/getTodo/").concat(id)
          /*,{ headers: this.headers}*/
          );
        }
      }, {
        ...
        value: function deleteTodo(id) {
          return this.http["delete"]("".concat(this.apiUrl, "/deleteTodo/").concat(id)
          /*, { headers: this.headers}*/
          );
        }
      }, {
        ...
        value: function updateTodo(id, todo) {
          return this.http.put("".concat(this.apiUrl, "/updateTodo/").concat(id), todo
          /*, {headers: this.headers}*/
          );
        }
      }, {
        key: "postTodo",
        value: function postTodo(todo) {
          return this.http.post("".concat(this.apiUrl, "/createTodo"), todo
          /*, {headers: this.headers}*/
          );
        }
      }, {
        key: "setImportantTodo",
        value: function setImportantTodo(todo) {
          this.updateTodo(todo._id, todo).subscribe(function (res) {}, function (error) {
        ...
        key: "removeFromImportantTodos",
        value: function removeFromImportantTodos(id, todo) {
          this.updateTodo(todo._id, todo).subscribe(function (res) {}, function (error) {
            console.log('error occured while setting todo status to important');
          });
          return true;
    ...
    TodosDataService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    TodosDataService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], TodosDataService);
    /***/
  },
  ...
  /***/
  function srcAppModulesAppmaterialAppmaterialModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesImportantImportantComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesImportantImportantComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_cores_services_todos_data_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/cores/services/todos-data.service */
    "./src/app/cores/services/todos-data.service.ts");
    /* harmony import */
    ...
    var ImportantComponent = /*#__PURE__*/function () {
      function ImportantComponent(todoDataService, _snackbar) {
      ...
      _createClass(ImportantComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.todoDataService.getImportantTodos().then(function (response) {
            _this2.todoData = response;
          }, function (errors) {
            _this2._snackbar.open('Failed to fetch important todos', 'Ok', {
    ...
    ImportantComponent.ctorParameters = function () {
      return [{
    ...
    ImportantComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-important',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./important.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/important/important.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./important.component.css */
      "./src/app/pages/important/important.component.css"))["default"]]
    })], ImportantComponent);
    /***/
  },
  ...
  /***/
  function srcAppPagesNewTodosNewTodosComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesNewTodosNewTodosComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NewTodosComponent", function () {
      return NewTodosComponent;
    });
    /* harmony import */
    ...
    var src_app_cores_services_todos_data_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/cores/services/todos-data.service */
    "./src/app/cores/services/todos-data.service.ts");
    /* harmony import */
    ...
    var NewTodosComponent = /*#__PURE__*/function () {
      function NewTodosComponent(route, todosDataService, _snackbar, http) {
        _classCallCheck(this, NewTodosComponent);

        this.route = route;
        this.todosDataService = todosDataService;
        this._snackbar = _snackbar;
        this.http = http; // object for form control
      ...
      _createClass(NewTodosComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {} // method for the form submission

      }, {
        key: "newTodosForm",
        value: function newTodosForm() {
          this.todosDataService.postTodo(this.todoDetails).subscribe();

          this._snackbar.open('New todo saved ', 'Ok', {
            horizontalPosition: 'right',
            verticalPosition: 'bottom'
          });
    ...
    NewTodosComponent.ctorParameters = function () {
      return [{
    ...
    NewTodosComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-new-todos',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./new-todos.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/new-todos/new-todos.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./new-todos.component.css */
      "./src/app/pages/new-todos/new-todos.component.css"))["default"]]
    })], NewTodosComponent);
    /***/
  },
  ...
  /***/
  function srcAppPagesPageLayoutPageLayoutComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesPageLayoutPageLayoutComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var PageLayoutComponent = /*#__PURE__*/function () {
      function PageLayoutComponent(_todoService) {
      ...
      _createClass(PageLayoutComponent, [{
        ...
        key: "mylogic",
        value: function mylogic() {
          var _this4 = this;

          this._todoService.getImportantTodos().then(function (importantTodos) {
            _this4.importantTaskCount = importantTodos.length;
    ...
    PageLayoutComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/page-layout/page-layout.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./page-layout.component.css */
      "./src/app/pages/page-layout/page-layout.component.css"))["default"]]
    })], PageLayoutComponent);
    /***/
  },
  ...
  /***/
  function srcAppPagesTodoUpdateTodoUpdateComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTodoUpdateTodoUpdateComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TodoUpdateComponent", function () {
    ...
    var TodoUpdateComponent = /*#__PURE__*/function () {
      function TodoUpdateComponent() {
        _classCallCheck(this, TodoUpdateComponent);
      }

      _createClass(TodoUpdateComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    TodoUpdateComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-todo-update',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./todo-update.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/todo-update/todo-update.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./todo-update.component.css */
      "./src/app/pages/todo-update/todo-update.component.css"))["default"]]
    })], TodoUpdateComponent);
    /***/
  },
  ...
  /***/
  function srcAppPagesTodosTodosComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPagesTodosTodosComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_cores_services_todos_data_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/cores/services/todos-data.service */
    "./src/app/cores/services/todos-data.service.ts");
    /* harmony import */
    ...
    var TodosComponent = /*#__PURE__*/function () {
      function TodosComponent(route, http, todoDataService, _dialog, _snackbar) {
        ...
        this.todoData = [];
        this.status = true;
        this.today = new Date(); // form control object
      ...
      _createClass(TodosComponent, [{
        ...
        value: function getTodos() {
          ...
          return this.todoDataService.getTodo().subscribe(function (data) {
            _this5.todoData = data;
          });
        ...
        key: "deleteTodo",
        value: function deleteTodo(todos) {
          var _this6 = this;

          this.todoDataService.deleteTodo(todos._id).subscribe(function (data) {
            _this6.todoData.splice(_this6.todoData.indexOf(todos), 1);
          });
        }
        /* myfunc(){
        ...
        key: "showEditTodoDialog",
        value: function showEditTodoDialog() {
        ...
        key: "saveUpdatesToTodo",
        value: function saveUpdatesToTodo(todo) {
          var _this7 = this;

          console.log('todo to update', todo);
          this.todoDataService.updateTodo(todo._id, todo).subscribe(function (response) {
            _this7._snackbar.open("Successfully saved changes to ".concat(todo.title), 'Ok', {
              horizontalPosition: 'right',
              verticalPosition: 'bottom'
            });

            _this7.editTodoModal.close();
          }, function (e) {
            _this7._snackbar.open("Failed to save changes to ".concat(todo.title), 'Ok', {
              horizontalPosition: 'right',
              verticalPosition: 'bottom'
            });
          });
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('editTodoTemplate', null)], TodosComponent.prototype, "editTodoTemplate", void 0);
    TodosComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./todos.component.css */
      "./src/app/pages/todos/todos.component.css"))["default"]]
    })], TodosComponent);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/valentine/sandbox/front-end/simple-todo-app/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
